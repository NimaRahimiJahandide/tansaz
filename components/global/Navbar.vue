...
<template>
  <div>
    ...
    <nav>
      <!-- top of navbar -->
      <div class="md:flex hidden justify-between items-center py-[15px] max-w-[1200px] mx-auto px-3">
        ...
        <div class="flex items-center gap-[10px]">
          <NuxtLink to="#" class="bg-[#333333] rounded-[10px] size-10 flex items-center justify-center max-h-10">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="#fff"
                d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4" />
            </svg>
          </NuxtLink>
          <NuxtLink to="#" class="bg-primary rounded-[10px] size-10 flex items-center justify-center max-h-10">
      ...
      <hr>
      <!-- bottom of navbar -->
      <ul class="md:flex hidden items-center justify-center py-[10px] sticky top-0">
        <li>
        ...
        <li class="relative navbar">
          <NuxtLink to="#"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="12px" height="12px" viewBox="0 0 40 40">
          ...
          <ul
            ...
            <li class="flex flex-col gap-[20px] flex-grow">
              <NuxtLink to="#"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14px" height="14px" viewBox="0 0 64 64">
                  <path fill="#EF172E"
              ...
              <ul class="list-disc list-inside marker:text-primary flex flex-col gap-1">
